...
export const deleteUser = async (userId: number) => {
  try {
    const response = await api.delete(`/api/user?userId=${userId}`);
    return response.data;
  } catch (err) {
    console.error(err);
    throw new Error("사용자 정보 조회 오류: api");
...
export const updateUserInfo = async (
  ...
  try {
    ...
    const response = await api.put(`/api/user?userId=${userId}`, formData, {
      headers: {
...
export const userFindById = async (userId: string) => {
  try {
    const response = await api.get(`/api/user/findById?userId=${userId}`);
    return response.data;
  } catch (err) {
    console.error(err);
...
export const getUserNoteData = async (userId: string) => {
  try {
    const response = await api.get(`/api/user/noteData?userId=${userId}`);
    return response.data;
  } catch (err) {
    console.error(err);
...
export const getCalendarData = async (userId: string) => {
  try {
    const response = await api.get(`/api/user/calanderData?userId=${userId}`);
    return response.data;
  } catch (err) {
    console.error(err);
...
export const getRecentData = async (userId: string) => {
  try {
    const response = await api.get(`/api/user/recentNote?userId=${userId}`);
    return response.data;
  } catch (err) {
    console.error(err);
...
export const getLikedData = async (userId: string) => {
  try {
    const response = await api.get(`/api/user/likedNote?userId=${userId}`);
    return response.data;
  } catch (err) {
    console.error(err);
...
export const changeLikedListPublic = async (userId: string) => {
  try {
    const response = await api.put(`/api/user/LikedPublic?userId=${userId}`);
    return response.data;
  } catch (err) {
    console.error(err);
